...
import 'package:movie_app/src/screens/movie_screen.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        ...
        Navigator.push(context,MaterialPageRoute(builder: (context) => MovieScreen(movieData)));
      },
      child: Hero(
        tag: movieData.id,
        child: Container(
                ...
                children: <Widget>[
                  ...
                  Positioned(
                    ...
                    child: Row(children: <Widget>[
                      Text('${movieData.voteAverage}',style: TextStyle(color: Colors.white),),
